...
class Preferences @Inject constructor(context: Context) : MainPreferences(context.getSharedPreferences("ontrak_preferences", Context.MODE_PRIVATE)) {
    ...
    companion object {
        ...
        private const val TIME_OFF_APPROVAL_ENABLED_PREF = "com.delphiaconsulting.timestar.TIME_OFF_APPROVAL_ENABLED_PREF"
        private const val TIME_ENTRY_ENABLED_PREF = "com.delphiaconsulting.timestar.TIME_ENTRY_ENABLED_PREF"
        private const val TIME_MANAGEMENT_ENABLED_PREF = "com.delphiaconsulting.timestar.TIME_MANAGEMENT_ENABLED_PREF"
    }
