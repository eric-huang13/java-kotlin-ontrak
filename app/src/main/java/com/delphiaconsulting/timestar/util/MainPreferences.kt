...
import com.delphiaconsulting.timestar.util.PunchMode.NO_PUNCH_MODE
...
open class MainPreferences(protected val sharedPref: SharedPreferences) {
    ...
    companion object {
        ...
        private const val TIME_PUNCH_MODE = "com.delphiaconsulting.timestar.TIME_PUNCH_MODE"
        private const val EMPLOYEE_ID_PREF = "com.delphiaconsulting.timestar.EMPLOYEE_ID_PREF"
        private const val ORG_LEVEL_SELECTION_PREF = "com.delphiaconsulting.timestar.ORG_LEVEL_SELECTION_PREF"
        private const val TIME_OFF_BALANCES_ENABLED_PREF = "com.delphiaconsulting.timestar.TIME_OFF_BALANCES_ENABLED_PREF"
        private const val TIME_OFF_REQUEST_ENABLED_PREF = "com.delphiaconsulting.timestar.TIME_OFF_REQUEST_ENABLED_PREF"
    }
